...
이 시스템이 무엇을 만들어야 하는지는 [docs/](docs/) 에 있습니다.

- [docs/REQUIREMENTS.md](docs/REQUIREMENTS.md) — 기능 98 · 비기능 18 · 인터페이스 7 · 데이터 31그룹, 설계원칙 P-01~P-06
- [docs/PROGRAMS.md](docs/PROGRAMS.md) — 프로그램 115건(취소 35 제외 80)과 0~7차 개발 순서
- [docs/README.md](docs/README.md) — 읽는 순서, 재변환 방법, **현재 구현과 문서 사이의 알려진 차이 6건**

아래 "구현 범위"의 모듈 구분은 저장소를 만들 때의 잠정 구분이며, 위 문서의 도메인 체계가 정본입니다.
